    ...
    <AnimatePresence>
      ...
      >
        ...
        <p className="text-lg p-3 md:p-5">
          ...
          business since 2003, working towards providing the best in opticals
          for our customers. We have earned our reputation as the best optical
          boutique in the area, offering a curated selection of exquisite
          eyewear collections.
        </p>
