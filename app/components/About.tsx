...
export default function About() {
  return (
    <div className="w-full md:w-[768px] bg-light-primary text-dark-primary mx-auto px-4 py-4 flex items-center justify-center flex-col p-2 md:p-4">
      <motion.h1
      ...
      <motion.p
        ...
        transition={{ duration: 0.4, ease: "easeInOut" }}
      >
        Welcome to Kaanchwala & Sons, previously Arihant Opticians, the premier
